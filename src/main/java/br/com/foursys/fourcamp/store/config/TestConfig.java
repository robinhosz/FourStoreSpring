...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Transaction o1 = new Transaction(null, Instant.parse("2019-06-20T19:53:07Z"), c1); 
		Transaction o2 = new Transaction(null, Instant.parse("2019-07-21T03:42:10Z"), c2); 
		Transaction o3 = new Transaction(null, Instant.parse("2019-07-22T15:21:22Z"), c1);
